...
describe('HomePage component', () => {
    ...
    beforeEach(() => {
        ...
        axios.get.mockImplementation(async (urlPath) => {
            if (urlPath === 'https://ecommerce-backend-tawny-rho.vercel.app/api/products') {
    ...
    it('add to cart buttons work', async () => {
        ...
        expect(axios.post).toHaveBeenNthCalledWith(1, 'https://ecommerce-backend-tawny-rho.vercel.app/api/cart-items', {
            productId: 'e43638ce-6aa0-4b85-b27f-e1d07eb678c6',
            quantity: 2
        });

        expect(axios.post).toHaveBeenNthCalledWith(2, 'https://ecommerce-backend-tawny-rho.vercel.app/api/cart-items', {
